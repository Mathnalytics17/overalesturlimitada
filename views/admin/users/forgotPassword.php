...
function admin_forgot_error(array $errors, string $field): ?string
{
  ...
  <div class="login">
    <div class="login-left">
      <div class="login-card">
        ...
        <p class="login-sub">Ingresa el correo del administrador para recibir el enlace de recuperación.</p>
        ...
        <form method="POST" action="/admin/users/forgotPassword">
          <?= Csrf::input(); ?>
